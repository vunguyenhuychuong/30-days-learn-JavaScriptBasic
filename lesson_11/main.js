/* 
    ...
    để tính điểm trung bình IMDB 
    của những bộ phim mà Christopher Nolan làm đạo diễn.


Dùng phương thức filter để lấy ra những bộ phim do Christopher 
Nolan làm đạo diễn
...
function calculateRating(watchList) {
    var Nolan = watchList.filter(function (watchList) {
        return watchList.Director === "Christopher Nolan"
    })
    var totalImdb = Nolan.reduce(function (total, value) {
